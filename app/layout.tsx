...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { rel: "icon", url: "/favicon/icon3.png", sizes: "16x16" },
      { rel: "icon", url: "/favicon/icon.png", sizes: "32x32" },
      { rel: "icon", url: "/favicon/icon2.png", sizes: "48x48" },
      { rel: "icon", url: "/favicon/icon1.png", sizes: "96x96" },
      { rel: "icon", url: "/favicon/icon4.svg", sizes: "any" },
      { rel: "icon", url: "/favicon/icon6.png", sizes: "512x512" },
    ],
